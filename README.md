...
| Surface | Status |
|---|---|
| Harness | DeepSeek Harness `0.1.2-rc.1` (peer ranges `>=0.1.2-rc.1 <0.2.0`; adapted 2026-09-02). Verified 2026-09-06 against the dsh-v0.1.3-alpha.1 master checkout (full gate chain + profile install smoke). |
| Node | `^22.19.0 \|\| >=24.0.0` |

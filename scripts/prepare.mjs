...
// `prepare` lifecycle: emits lib/types (tsc declarations) and lib/index.js
// (tsdown bundle). Uses ONLY the build tools declared in `dependencies`
...
// tsdown first: its clean:true rewrites the whole lib/ outDir and would wipe
// the tsc-emitted declaration tree if tsc ran before it.
